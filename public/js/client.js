...
function showAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>PVS_MEETING Made with ❤️</strong>",
    imageAlt: "About",
    imageUrl: aboutImg,
    html: `
        <br/>
        <div id="about">
            <b style="color:blue">DSKKS </b> project on
            <a href="" target="_blank"><br/></br>
            <img alt="Github" src="../images/dept.png"></a><br/><br/>
        </div>
        </br>
        <div id="author">Authors :SUDARSAN <a href="" target="_blank"> </a> & KAVIN SANKAR<a href="" target="_blank"> </a></div>
        `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
